...
const rootDir = path.resolve(__dirname); // points to /versioning

const commitsPath = path.join(rootDir, "commits.json");
const modePath = path.join(rootDir, "versioningMode.json");
